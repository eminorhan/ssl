...
from utils import train, validate, adjust_learning_rate, set_parameter_requires_grad
...
parser.add_argument('--schedule', default=[13, 14], nargs='*', type=int, help='learning rate schedule (when to drop lr by a ratio)')
parser.add_argument('--resume', default='', type=str, help='path to model checkpoint (default: none)')
...
def main():
    ...
    if args.resume:
        if os.path.isfile(args.resume):
            print("=> loading model at '{}'".format(args.resume))
